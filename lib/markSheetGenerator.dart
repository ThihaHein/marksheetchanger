...
class _MarkStatementGeneratorState extends State<MarkStatementGenerator> {
  ...
  // Institution details
  final _institutionNameController = TextEditingController(text: 'Jnanadeep University');
  final _examTitleController = TextEditingController(text: 'Final Year - 2022');
  final _examSubtitleController = TextEditingController(text: 'Diploma In Education');
  final _examVersionController = TextEditingController(text: '');
  ...
  Future<void> _generatePDF(Map<String, dynamic> student) async {
    ...
    final signatureBytes = await rootBundle.load('assets/images/signature1.png');
    final signatureImage = signatureBytes.buffer.asUint8List();
    final signature2Bytes = await rootBundle.load('assets/images/signature2.png');
    final signature2Image = signature2Bytes.buffer.asUint8List();
    ...
    subjects = [
      {
        ...
        'paper': student['firstSubjectCode'],
        'maxMarks': 100,
        'minMarks': 40,
      ...
      },
      {
        ...
        'paper':  student['secondSubjectCode'],
        'maxMarks': 100,
        'minMarks': 40,
      ...
      },
      {
        ...
        'paper': student['thirdSubjectCode'],
        'maxMarks': 100,
        'minMarks': 40,
      ...
      },
      {
        ...
        'paper': student['fourthSubjectCode'],
        'maxMarks': 100,
        'minMarks': 40,
      ...
      },
      {
        ...
        'paper': student['fifthSubjectCode'],
        'maxMarks': 100,
        'minMarks': 40,
      ...
      },
      {
        ...
        'paper': student['sixthSubjectCode'],
        'maxMarks': 100,
        'minMarks': 40,
      ...
      {
        'name': student['seventhPaperName'],
        'paper': student['seventhSubjectCode'],
        'maxMarks': 100,
        'minMarks': 40,
        'theoryMarks': student['seventhPaperTheory'],
        'practMarks': student['seventhPaperPract'],
        'grade': student['seventhPaperGrade'],
      },
      {
        'name': student['eighthPaperName'],
        'paper': student['eighthSubjectCode'],
        'maxMarks': 100,
        'minMarks': 40,
        'theoryMarks': student['eighthPaperTheory'],
        'practMarks': student['eighthPaperPract'],
        'grade': student['eighthPaperGrade'],
      },
      {
        'name': student['ninthPaperName'],
        'paper': student['ninthSubjectCode'],
        'maxMarks': 100,
        'minMarks': 40,
        'theoryMarks': student['ninthPaperTheory'],
        'practMarks': student['ninthPaperPract'],
        'grade': student['ninthPaperGrade'],
      },
                          ...
                          children: [
                            pw.Row(
                              children: [
                                ...
                                pw.Text(': ${student['registrationNumber'] ?? '220419321-2'}'),
                              ],
                            ),
                    ...
                    pw.Row(
                      ...
                      children: [
                        pw.Column(
                          crossAxisAlignment: pw.CrossAxisAlignment.center,
                          children: [
                            pw.Image(pw.MemoryImage(signatureImage), width: 50, height: 50),
                            pw.Text('Checked By'),
                            pw.Text('Date :- ${DateFormat("dd / MMMM / yyyy").format(_selectedDate!)}'),
                          ],
                        ),
                        ...
                        pw.Column(
                          crossAxisAlignment: pw.CrossAxisAlignment.center,
                          children: [
                            pw.Image(pw.MemoryImage(signature2Image), width: 50, height: 50),
      ...
      children: [
        ...
        ...subjects.map((subject) => pw.TableRow(
          children: [
            ...
            if(subject['name']!= null)
              pw.Padding(
                padding: const pw.EdgeInsets.all(5),
                child: pw.Text('${subject['minMarks'] ?? ''}', textAlign: pw.TextAlign.center),
              ),
            if(subject['practMarks']!= null)
              pw.Padding(
                padding: const pw.EdgeInsets.all(5),
                child: pw.Text('${subject['practMarks'] ?? ''}', textAlign: pw.TextAlign.center),
              ),
            if(subject['theoryMarks']!= null)
              pw.Padding(
                padding: const pw.EdgeInsets.all(5),
        ...
        pw.TableRow(
          children: [
            ...
            pw.Padding(
              padding: const pw.EdgeInsets.all(5),
              child: pw.Text('900', textAlign: pw.TextAlign.center, style: pw.TextStyle(font: fontBold)),
            ),
            pw.Padding(
              padding: const pw.EdgeInsets.all(5),
              child: pw.Text('', textAlign: pw.TextAlign.center, style: pw.TextStyle(font: fontBold)),
            ),
            pw.Padding(
              padding: const pw.EdgeInsets.all(5),
        ...
        if(grandTotal !='0')
          pw.TableRow(
            children: [
              ...
              pw.Padding(
                padding: const pw.EdgeInsets.all(5),
                child: pw.Text('$grandTotal', textAlign: pw.TextAlign.center, style: pw.TextStyle(font: fontBold)),
              ),
              pw.Padding(
                padding: const pw.EdgeInsets.all(5),
                child: pw.Text('', textAlign: pw.TextAlign.center),
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Card(
                      ...
                      child: ListTile(
                        ...
                        subtitle: Text(
                          'Roll No: ${student['rollNo'] ?? 'N/A'} | S.No: ${student['registrationNumber'] ?? 'N/A'}',
                        ),
